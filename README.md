...
2. Choose browser login. Allow Study Space to handle its return link when your browser asks, then open Moodle in a new tab. Keep the original Study Space tab open; it checks for completion automatically.

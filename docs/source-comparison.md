...
The [reviewed workflow](reviewed-pipeline.md) adds source-level relevance/structure review and hierarchy-first drill-down before this fine-grained comparison. Both views retain the same source identities and exact provenance foundation.
